...
export default function WorkspaceSelector({
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold text-gray-900">QTI 3.0 採点システム</h1>
      ...
      <div className="mb-10 rounded-lg border border-gray-200 bg-white p-4">
        <h2 className="mb-3 text-lg font-semibold text-gray-900">ワークスペースのインポート</h2>
      ...
      {workspaces.length > 0 && (
        <div>
          <h2 className="mb-4 text-xl font-semibold text-gray-900">既存のワークスペース</h2>
                    ...
                    {editingWorkspace === workspace.id ? (
                      ...
                      <>
                        ...
                        {workspace.description && (
                          <p className="mb-2 text-gray-600">{workspace.description}</p>
                        )}
                        {expandedWorkspaces.has(workspace.id) && (
      ...
      {workspaces.length === 0 && !loading && (
        <div className="py-12 text-center">
          <div className="mb-4 text-gray-500">まだワークスペースがありません</div>
