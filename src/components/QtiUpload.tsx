  ...
  return (
    <div className="mx-auto w-full max-w-2xl p-6">
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        <h2 className="mb-4 text-lg font-semibold text-gray-900">QTI 3.0 ワークスペースを作成</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="workspaceName" className="mb-1 block text-sm font-medium text-gray-700">
              ワークスペース名 *
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-gray-700"
            />
            <div className="mt-1 text-xs text-gray-500">選択中: {resultFiles.length}件</div>
          </div>
        </div>
        ...
        {error && (
          <div className="mt-4 rounded-lg border border-red-200 bg-red-50 p-4">
            ...
            <div className="mt-1 text-sm whitespace-pre-line text-red-600">{error}</div>
          </div>
        )}
